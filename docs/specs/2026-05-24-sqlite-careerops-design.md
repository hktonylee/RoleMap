...
The TUI starts with a searchable list. Typing filters by company, title, URL, salary, publish date, and description. Enter opens a details viewer; Escape or `q` returns or exits depending on the current view.
